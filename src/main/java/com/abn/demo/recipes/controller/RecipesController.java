package com.abn.demo.recipes.controller;
...
import com.abn.demo.recipes.exceptions.BadRequestException;
import com.abn.demo.recipes.exceptions.ErrorMessages;
import com.abn.demo.recipes.exceptions.NoSuchRecipeFoundException;
import com.abn.demo.recipes.exceptions.RecipeNotCreatedException;
import com.abn.demo.recipes.exceptions.ResourceConflictException;
import com.abn.demo.recipes.exceptions.UnAuthorizedException;
import com.abn.demo.recipes.pojos.Recipe;
import com.abn.demo.recipes.pojos.User;
import com.abn.demo.recipes.service.RecipesService;
import com.abn.demo.recipes.util.Util;
...
public class RecipesController {
	...
	public ResponseEntity<Recipe> createRecipe(
			@RequestHeader(value = "Authorization", required = true) String authHeader, @RequestBody Recipe recipe) {
	...
	public ResponseEntity<Recipe> getRecipe(@RequestHeader(value = "Authorization", required = true) String authHeader,
	...
	public ResponseEntity<String> deleteRecipe(
			@RequestHeader(value = "Authorization", required = true) String authHeader, @PathVariable Integer id) {
